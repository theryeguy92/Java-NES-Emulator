...
/**
 * This class represents a DMC Channel of the APU
 */
public class DMCChannel {
    ...
    public void computeSample() {
        ...
        if (sample_buffer == 0x00 && memoryReader.getBytesRemaining() > 0) {
            ...
            if (memoryReader.getBytesRemaining() == 0) {
                if (loop) {
                    memoryReader.setCurrentAddress(sample_address);
                    memoryReader.setBytesRemaining(sample_length);
                } else if (irqEnabled) {
                    interrupt = true;
                }
            }
    ...
    public void clearReader() {
        memoryReader.setBytesRemaining(0);
    }
    ...
    public boolean hasBytesLeft() {
        return memoryReader.getBytesRemaining() > 0;
    }
